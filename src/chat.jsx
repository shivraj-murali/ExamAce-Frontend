  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessages([
        ...
        { 
          role: 'assistant', 
          content: data.response || "I'm ExamAce, your educational assistant. How can I help you with your studies today?" 
        }
      ]);
    } catch (error) {
        ...
        <div className="w-[95%] mx-auto">
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-gray-300 space-y-4 mt-8">
              ...
              <p className="text-2xl font-medium text-white">Welcome to ExamAce</p>
              <p className="text-center max-w-md text-gray-300 text-base">I'm your educational assistant, ready to help you learn, understand, and excel in your studies.</p>
            </div>
          ) : (
